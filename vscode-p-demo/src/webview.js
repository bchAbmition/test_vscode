...
const oilControl = require('./oilControl');
var Oil = require('./oilType');
/**
...
const messageHandler = {
    ...
    openFile(global, message) {
        var content = oilControl.openFile(`${global.projectPath}/${message.path}`);
        var OS = new Oil();
        OS.GetOs(content.CPU[0]);
        invokeCallback(global.panel, message, {code: 0, text: '成功'});
    },
};
